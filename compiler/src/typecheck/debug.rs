...
use crate::typecheck::infer::types::{Instance, Type, TypeKind, context::TypeContext};
use std::fmt::Debug;

pub fn debug_instance(instance: &Instance, context: &mut TypeContext) -> String {
    format!(
        "({:?}{})",
...
pub fn debug_type(r#type: &Type, context: &mut TypeContext) -> String {
