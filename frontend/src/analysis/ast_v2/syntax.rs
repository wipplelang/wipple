...
pub(in crate::analysis::ast_v2) trait Syntax
where
    Self: 'static,
{
...
#[async_trait]
pub(in crate::analysis::ast_v2) trait SyntaxContext:
    Clone + Send
{
...
pub(in crate::analysis::ast_v2) struct SyntaxRule<S: Syntax + ?Sized> {
    pub name: &'static str,
    pub kind: SyntaxRuleKind<S>,
}

pub(in crate::analysis::ast_v2) enum SyntaxRuleKind<S: Syntax + ?Sized> {
    Function(
        Box<
            dyn Fn(
                    S::Context,
...
pub(in crate::analysis::ast_v2) struct SyntaxRules<S: Syntax + ?Sized>(Vec<SyntaxRule<S>>);
...
impl AstBuilder {
    pub(in crate::analysis::ast_v2) async fn build_list<S: Syntax>(
        &self,
        context: S::Context,
        span: parse::Span,
        exprs: &[parse::Expr],
