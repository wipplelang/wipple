...
const defaultTutorialStore: TutorialStore = {};

const TutorialStoreContext = createContext<
    [TutorialStore, React.Dispatch<React.SetStateAction<TutorialStore>>]
>([defaultTutorialStore, () => {}]);

export const TutorialProvider = (props: React.PropsWithChildren<{}>) => {
    const [store, setStore] = useState(defaultTutorialStore);

    return (
        <TutorialStoreContext.Provider value={[store, setStore]}>
            {props.children}
...
export const useOnTutorialAction = (
    ...
    const [store, _setStore] = useTutorialStore();
