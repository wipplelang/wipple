...
macro_rules! syntax_group {
    ($(#[$attr:meta])* $vis:vis type $name:ident<$context:ty> {
        ...
        paste::paste! {
            ...
            impl $crate::analysis::ast_v2::syntax::Syntax for [<$name Syntax>] {
                type Context = $context;

                fn rules() -> $crate::analysis::ast_v2::syntax::SyntaxRules<Self> {
                    $crate::analysis::ast_v2::syntax::SyntaxRules::new()
                    $(
