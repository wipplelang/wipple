...
<div
    class="relative printing:hidden shrink-0"
...
>
    <div
        use:layout
        class="absolute inset-0 max-w-full h-full py-[10px]"
        style:width="{width}px"
        style:min-width="{width}px"
    >
        <div bind:this={background} class="absolute inset-0 bg-background-secondary/50"></div>
        ...
        {#each cards as card, index (index)}
            <div
                ...
                class="absolute inset-x-[10px] flex flex-col gap-[4px] border-standard rounded-[10px] p-[10px] bg-background-secondary-alt data-primary:border-blue-500/50 data-primary:bg-(--primary-color) overflow-scroll data-hidden:opacity-0 transition duration-250"
            ...
            >
                <div class="font-semibold">
                    {#if card.primary}
                        <p
                            class="text-blue-500 font-semibold mb-[4px] flex flex-row items-center gap-[5px]"
                        >
                            <Icon>error</Icon>
