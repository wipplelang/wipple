...
pub(crate) fn setup(env: &mut Environment) {
    env.add_primitive_conformance("builtin 'Module ::= Text'", |_: Module| Text {
        text: String::from("<module>"),
        location: None,
    });

    env.add_primitive_conformance("builtin 'Module ::= Function'", |module: Module| {
    ...
    env.add_primitive_conformance("builtin 'Module-Block ::= Text'", |_: ModuleBlock| Text {
        text: String::from("<module block>"),
        location: None,
    });

    env.add_primitive_conformance(
        "builtin 'Module-Block ::= Evaluate'",
    ...
    env.add_primitive_conformance(
        "builtin 'Module-Block ::= Macro-Expand'",
        |module_block: ModuleBlock| {
