...
pub fn infer_pattern(
    pattern: WithInfo<&mut crate::typecheck::Pattern>,
    ...
    match pattern.item {
        crate::typecheck::Pattern::Unknown => {}
        ...
        crate::typecheck::Pattern::Variable(_, variable) => {
            ...
            let field_types = match &r#type.item.kind {
                TypeKind::Declared { path, parameters } => {
                    ...
                    match type_declaration.item.representation.item {
                        crate::typecheck::TypeRepresentation::Structure(field_types) => {
        ...
        crate::typecheck::Pattern::Marker(path) => {
            let type_declaration = context.driver.get_type_declaration(path);
        ...
        crate::typecheck::Pattern::Wrapper {
            ...
            let value_type = match type_declaration.item.representation.item {
                crate::typecheck::TypeRepresentation::Wrapper(wrapped) => infer_type(
                    context.driver,
                    wrapped.as_ref(),
                    instantiation_context.type_context,
                    instantiation_context.error_queue,
