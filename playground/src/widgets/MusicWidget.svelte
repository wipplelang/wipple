...
<script lang="ts">
    import MusicPreview from "@/components/MusicPreview.svelte";
    import ObjectWrapper from "@/components/ObjectWrapper.svelte";
    import { trackWidgetValue } from "./util.svelte";
    import { type Music } from "@/assets/music";
    import MusicEditor from "@/components/MusicEditor.svelte";
    import { getDefaultSoundfontInstrument, getDrumMachine } from "@/assets/instruments";
