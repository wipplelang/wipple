...
export const energySources = [
    {
        ...
        info: "Coal is used to generate energy through the [process of burning](https://www.usgs.gov/faqs/what-coal-used). The heat generated through coal combustion is used to generate steam which in return generates electricity. Similarly, to natural gas, coal is an abundant source of energy, with there being [1.16 trillion short tons](https://illuminem.com/illuminemvoices/examining-the-pros-and-cons-of-coal-as-an-energy-source) of coal reserves on the planet. Additionally, coal is cheaper than other fossil fuels which makes it easier to distribute worldwide. At the same time, mining coal can lead to water pollution. Mining coal can cause acid mine drainage which runs into water and can disrupt the growth and reproduction of aquatic plants. [Coal mining](https://illuminem.com/illuminemvoices/examining-the-pros-and-cons-of-coal-as-an-energy-source) can also cause destruction to natural habitats as coal mining requires land clearing and excavation. ",
    },
    {
        name: "Natural Gas",
        ...
        emissionsSource: "https://www.eia.gov/environment/emissions/co2_vol_mass.php",
        info: "Natural gas is converted into energy by being extracted from the ground and used by [boilers to create steam](http://energyforprogress.org/article/one-question-on-energy-how-does-natural-gas-become-electricity/). This steam is then used to spin a turbine which generates electricity. Alternatively, a combustion turbine is used to create a rotating mass to create electricity. While not renewable, natural gas is an abundant source of energy. Natural gas production reached a record high level of 79 billion cubic feet per day in 2015 so it is unlikely we’ll run out of it soon. While not entirely clean, [natural gas emits half of the carbon dioxide that coal does when burned.](https://yaleclimateconnections.org/2016/07/pros-and-cons-the-promise-and-pitfalls-of-natural-gas/) While plentiful, this does not change the fact that natural gas is a nonrenewable source of energy. At some point, we will run out of natural gas. Another downside is that natural gas leaks emit huge amounts of methane into the atmosphere, almost [100,000 tons](https://yaleclimateconnections.org/2016/07/pros-and-cons-the-promise-and-pitfalls-of-natural-gas/).",
    },
    {
        name: "Solar",
