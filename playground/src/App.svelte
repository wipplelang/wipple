<script lang="ts">
    import { playgroundMetadata, type Playground } from "@/models/Playground";
    ...
    import Output, { type RunState } from "@/components/Output.svelte";
...
{#if playground}
    ...
    >
        ...
        <div class="flex max-h-full flex-1 flex-row gap-[10px] overflow-hidden p-[10px]">
            ...
            <div class="flex min-w-[350px] flex-[1.25] shrink-0 flex-col gap-[10px]">
                ...
                <Box class="relative flex-1 overflow-scroll" scroll={false}>
                    <div class="flex min-h-full flex-row overflow-visible">
                        <div
                            class={[
