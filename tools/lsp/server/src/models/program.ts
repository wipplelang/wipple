...
export interface Declarations {
    types: Record<number, Declaration<TypeDeclaration>>;
    type_parameters: Record<number, Declaration<undefined>>;
    traits: Record<number, Declaration<TraitDeclaration>>;
    generic_constants: Record<number, GenericConstantDeclaration>;
    monomorphized_constants: Record<number, [undefined, number, Declaration<Expression>]>;
    variables: Record<number, Declaration<Type>>;
}
